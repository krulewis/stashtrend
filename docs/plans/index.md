...
- **Stashtrend Design Guide v1.0 Alignment** — 3-PR CSS update to match official design guide. Plans: `ui-update-requirements.md`, `ui-update-research.md`, `ui-update-architecture.md`, `ui-update-pr1-plan.md`. PR 1 (Tokens + Typography): in progress. PR 2 (Navigation + Interactive): planned. PR 3 (Polish): planned.
